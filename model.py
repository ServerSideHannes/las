...
Original file is located at
    https://colab.research.google.com/drive/14w18HUlacVEamwdgw85QmY6J1KL4RY5v
"""
...
"""
All hardcoded strings will be replaced such that each datapoint is selected uniformly
"""

def get_data_batch(batch_size, t_length):
  audio_path = "/content/61-70968-0002.wav"
  audio, sampling_rate = librosa.load(audio_path)
  mel_spectrogram = librosa.feature.melspectrogram(y=audio, sr=sampling_rate, n_mels=256, hop_length=128, fmax=8000)
  
  x_1 = tf.convert_to_tensor(mel_spectrogram,  dtype="float32")
  x_1 = tf.expand_dims(x_1, axis=0)
  
  s = 'a golden fortune and a  happy life'
  s = pd.Series(list(s))
  
  y = np.array(pd.get_dummies(s)[0:t_length])
  y = tf.convert_to_tensor(y,  dtype="float32")
  
  x_2 = y[0:-1]
  x_2 = tf.expand_dims(x_2, axis=0)
